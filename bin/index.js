...
;// CONCATENATED MODULE: ./node_modules/appstore-connect-jwt-generator-core/dist/esm/index.mjs
...
;// CONCATENATED MODULE: ./bin/client.js
...
class Client {
    constructor(param){
        this.listBundleIds = async (query)=>{
            ...
            const response = await node_ponyfill(uri, {
                headers
            });
...
/* harmony default export */ const bin_client = (Client);
...
const main_filename = (0,external_url_.fileURLToPath)("file:///Users/ken-yo/git/poad/apple-provisioning-profiles-downloader/bin/main.js");
const main_dirname = external_path_.dirname(main_filename);
class ProvisioningProfileDownloader {
    constructor(){
        this.run = async ()=>{
            try {
                ...
                const basePath = external_path_.join(process.env.HOME, '/Library/MobileDevice/Provisioning Profiles');
...
export { __webpack_exports__ProvisioningProfileDownloader as ProvisioningProfileDownloader };
