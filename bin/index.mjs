...
// EXPORTS
__nccwpck_require__.d(__webpack_exports__, {
  "R": () => (/* binding */ ProvisioningProfileDownloader),
  "Z": () => (/* binding */ main)
});
...
;// CONCATENATED MODULE: ./node_modules/appstore-connect-jwt-generator-core/dist/index.mjs
...
function jwtGenCore() { }
function tokenSync(privateKey, issuerId, privateKeyId, duration = 500) { return jsonwebtoken.sign({}, privateKey, signOption(issuerId, privateKeyId, duration)); }
;
...
/* harmony default export */ const appstore_connect_jwt_generator_core_dist = ((/* unused pure expression or super */ null && (jwtGenCore)));
//# sourceMappingURL=index.mjs.map
;// CONCATENATED MODULE: ./bin/client.mjs
...
const ProvisioningProfileDownloader = async () => {
    try {
        ...
        if (apiPrivateKey.length === 0) {
            const keyPath = external_path_.resolve(main_dirname, apiPrivateKeyFile);
            const apiPrivateKeyFileCheck = external_fs_.statSync(keyPath).isFile() || false;
        ...
        const privateKey = apiPrivateKey || external_fs_.readFileSync(external_path_.resolve(apiPrivateKeyFile));
        ...
        profiles
            ...
            return {
                fullPath: external_path_.join(basePath, profileFilename),
...
/* harmony default export */ const main = (ProvisioningProfileDownloader);
//# sourceMappingURL=main.mjs.map
})();

var __webpack_exports__ProvisioningProfileDownloader = __webpack_exports__.R;
var __webpack_exports__default = __webpack_exports__.Z;
export { __webpack_exports__ProvisioningProfileDownloader as ProvisioningProfileDownloader, __webpack_exports__default as default };
