...
var AppleProvisioningProfilesDownloader;
(function (AppleProvisioningProfilesDownloader) {
    AppleProvisioningProfilesDownloader.run = async () => {
        try {
...
})(AppleProvisioningProfilesDownloader || (AppleProvisioningProfilesDownloader = {}));
export default AppleProvisioningProfilesDownloader;
AppleProvisioningProfilesDownloader.run();
